...
// Movies newly available to stream/rent/buy digitally (or on TV), US region.
// Uses TMDB discover with a digital/TV release-type filter over a rolling
// recent window, so this reflects streaming availability rather than
...
async function getNewReleases() {
  ...
  url.searchParams.set("with_release_type", "4|6");
