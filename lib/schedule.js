...
// Anchor date: the start of the (UTC) week bucket during which the FIRST
// person in ROTATION_ORDER ("squishy king") picks. All other weeks are
// calculated relative to this anchor, so the rotation lines up correctly.
const ROTATION_ANCHOR = new Date("2026-07-20T00:00:00.000Z");
